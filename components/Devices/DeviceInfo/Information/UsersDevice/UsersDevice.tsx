        ...
        <div className={blockClasses}>
            ...
            <div className='grid grid-cols-2 gap-2 font-medium'>
                {users.map((item, index) => {
                    return (
                        <div key={index} className='flex flex-row items-center gap-2 bg-light-lighter dark:bg-light-lighterD h-8 w-full pl-1'>
                            <UserIcon fill={theme === 'dark' ? '#bebebe' : '#6C7281'}/>
                            <p className=''>
                                {item.login}
                            </p>
                        </div>
