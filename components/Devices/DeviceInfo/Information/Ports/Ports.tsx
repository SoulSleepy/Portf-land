        ...
        <div className={blockClasses}>
            ...
            <div className='flex flex-col'>
                <div className='grid grid-cols-4 items-center text-sm font-medium text-text-light border-t-[1px] border-l-[1px]'>
                    <p className={tableItemClasses}>Номер</p>
                    <p className={tableItemClasses}>Тип устройства</p>
                    <p className={tableItemClasses}>Протокол</p>
                    <p className={tableItemClasses}>Баннер</p>
                </div>
                {ports ? (
                    ports.map((item) => {
                        return (
